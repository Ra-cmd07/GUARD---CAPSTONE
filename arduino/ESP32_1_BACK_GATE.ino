// ============================================================================
// ESP32 #1 - BACK GATE SCANNER - AttendBox v4.0
// ============================================================================
// ESP32 MAC Address: 1C:C3:AB:B4:D7:A6
// Beacon ID: BEACON_GATE1
// Location: Back Gate (Gate 2 - Back Entrance)
// 
// ⚠️ UPLOAD THIS FILE TO ESP32 WITH MAC: 1C:C3:AB:B4:D7:A6
// 
...
// ═══════════════════════════════════════════════════════════════════════
// CONFIGURATION - ESP32 #1 BACK GATE
// ═══════════════════════════════════════════════════════════════════════
...
// ⭐ THIS ESP32 IDENTITY - PRE-CONFIGURED FOR BACK GATE
const char* MY_BEACON_ID = "BEACON_GATE2";
const char* MY_LOCATION_NAME = "Back Gate";
...
float calculateDistance(int rssi, int txPower = -70, float n = 1.8) {
  // CALIBRATED FOR: Outdoor/Semi-outdoor (Back Gate)
  // txPower = -70 (calibrated from actual RSSI=-59 at 0.25m distance)
  // n = 1.8 (optimized for open outdoor area with minimal obstacles)
  // 
...
void setup() {
  ...
  Serial.println("\n\n╔════════════════════════════════════════════════════════════╗");
  Serial.println("║  ESP32 #1 - BACK GATE SCANNER - v4.0                    ║");
  ...
  Serial.println("   ESP32 MAC: 1C:C3:AB:B4:D7:A6");
  ...
  Serial.println("║   Monitoring Back Gate entrance/exit                      ║");
  Serial.println("╚════════════════════════════════════════════════════════════╝\n");
