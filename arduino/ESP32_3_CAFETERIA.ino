// ============================================================================
// ESP32 #3 - CAFETERIA SCANNER - AttendBox v4.0
// ============================================================================
// ESP32 MAC Address: 28:05:A5:33:0F:B2
// Beacon ID: BEACON_ROOM202
// Location: School Cafeteria
// 
// ⚠️ UPLOAD THIS FILE TO ESP32 WITH MAC: 28:05:A5:33:0F:B2
// 
...
// ═══════════════════════════════════════════════════════════════════════
// CONFIGURATION - ESP32 #3 CAFETERIA
// ═══════════════════════════════════════════════════════════════════════
...
// ⭐ THIS ESP32 IDENTITY - PRE-CONFIGURED FOR CAFETERIA
const char* MY_BEACON_ID = "BEACON_CAFETERIA";
const char* MY_LOCATION_NAME = "School Cafeteria";
...
float calculateDistance(int rssi, int txPower = -70, float n = 2.2) {
  // CALIBRATED FOR: Large Open Indoor Space (Cafeteria)
  // txPower = -70 (calibrated from actual RSSI=-59 at 0.25m distance)
  // n = 2.2 (optimized for open cafeteria with tables, fewer walls)
  // 
...
void setup() {
  ...
  Serial.println("\n\n╔════════════════════════════════════════════════════════════╗");
  Serial.println("║  ESP32 #3 - CAFETERIA SCANNER - v4.0                    ║");
  ...
  Serial.println("   ESP32 MAC: 28:05:A5:33:0F:B2");
  ...
  Serial.println("║   Monitoring Cafeteria common area                       ║");
  Serial.println("╚════════════════════════════════════════════════════════════╝\n");
