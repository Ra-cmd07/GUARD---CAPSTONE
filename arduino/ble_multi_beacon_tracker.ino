// ============================================================================
// ESP32 MULTI-BEACON LOCATION TRACKER - AttendBox v4.0
// ============================================================================
...
// 
// How it works:
// 1. ESP32 scans for student BLE tags
// 2. Also scans for other beacon ESP32 devices
// 3. Compares RSSI from multiple beacons
// 4. Determines closest beacon = student location
// 5. Sends location update with RSSI from all visible beacons
// ============================================================================
...
const char* MY_LOCATION_NAME = "Cafeteria";
  ...
  if (httpCode == 200) {
    ...
    if (!error) {
      ...
      for (JsonObject beaconObj : beaconsArray) {
        ...
        beacon.macAddress = beaconObj["mac_address"].as<String>(); // NEW FIELD!
...
void setup() {
  ...
  Serial.println("\n\n╔════════════════════════════════════════════════════════════╗");
  Serial.println("║  Multi-Beacon Location Tracker - ESP32 v4.0             ║");
